...
# Restaura as dependências da API apontando para o caminho correto
RUN dotnet restore "backend/AgivysSystem.Api/AgiVysSystem.csproj"

# Compila o projeto em modo Release
RUN dotnet publish "backend/AgivysSystem.Api/AgiVysSystem.csproj" -c Release -o /app/publish /p:UseAppHost=false
